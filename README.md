...
<!-- [![Build Status](https://travis-ci.org/julienmoeys/macroutils.svg?branch=master)](https://travis-ci.org/julienmoeys/macroutils.svg?branch=master) -->
[![CRAN_Status_Badge](http://www.r-pkg.org/badges/version/soiltexture)](http://cran.r-project.org/package=soiltexture)
