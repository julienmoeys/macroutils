...
#' 
#'
#'@example  inst/examples/macroutilsInfo-examples.R
#'
#'
#'@export
#' 
...
macroutilsInfo <- function( 
    ...
    #   depends <- TRUE; md5 <- TRUE; packages <- "macroutils"; verbose <- TRUE
...
#   macroutilsInfo( file = "macroutilsInfo.txt", depends = TRUE ) 
#   macroutilsInfo( packages = "macrolegions" ) 
